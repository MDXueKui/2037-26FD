...
#define OFF_PIN                  GPIO_PIN_7
#define OFF_GPIO_PORT            GPIOF
#define OFF_KEY                  GPIO_ReadInputBit(OFF_GPIO_PORT, OFF_PIN)
#define OFF_GPIO_CLK             RCM_AHB_PERIPH_GPIOF
#define OFF_PRES                 0X6
...
#define fire_control_input_PIN                     GPIO_PIN_14
...
#define fire_control24v_input_PIN                  GPIO_PIN_15
...
#define cascaded24vR_input_PIN                      GPIO_PIN_11
#define cascaded24vR_input_GPIO_PORT                GPIOA
#define cascaded24vR_input_KEY                      GPIO_ReadInputBit(cascaded24vR_input_GPIO_PORT, cascaded24vR_input_PIN)
#define cascaded24vR_input_GPIO_CLK                 RCM_AHB_PERIPH_GPIOA
#define cascaded24vR_input_Triggering               0X10

#define cascaded24vL_input_PIN                      GPIO_PIN_12
...
#define rain_input_PIN                             GPIO_PIN_15
...
// #define up1_input_PIN                               GPIO_PIN_4
...
// #define down1_input_PIN                             GPIO_PIN_5
// #define down1_input_GPIO_PORT                       GPIOA
// #define down1_input_KEY                             GPIO_ReadInputBit(down1_input_GPIO_PORT, down1_input_PIN)
// #define down1_input_GPIO_CLK                        RCM_AHB_PERIPH_GPIOA
...
#define MOSI_GPIO_CLK                               RCM_AHB_PERIPH_GPIOC
