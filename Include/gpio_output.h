 ...
 * @LastEditTime: 2024-05-14 18:47:43
 * @FilePath: \MDKe:\pengdong\APM32F0xx_SDK_v1.7\Examples\GPIO\GPIO_Toggle\Include\gpio_output.h
...
#define cascaded_outputA_GPIO_PIN          GPIO_PIN_7
#define cascaded_outputA_GPIO_PORT         GPIOA
#define cascaded_outputA_GPIO_CLK          RCM_AHB_PERIPH_GPIOA

#define cascaded_outputB_GPIO_PIN          GPIO_PIN_0
#define cascaded_outputB_GPIO_PORT         GPIOB
#define cascaded_outputB_GPIO_CLK          RCM_AHB_PERIPH_GPIOB

#define firefeedback_output_GPIO_PIN       GPIO_PIN_14
#define firefeedback_output_PORT           GPIOB
#define firefeedback_output_CLK            RCM_AHB_PERIPH_GPIOB
